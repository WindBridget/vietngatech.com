...
<?php
$id = $_GET['id'];
$str2 = "SELECT * FROM tbl_news WHERE id = $id";
$result2 = mysql_query($str2);
$rows2 = mysql_fetch_array($result2);


$str = "SELECT * FROM tbl_group_news WHERE level=0 AND id_lang=$id_lang";
$result = mysql_query($str);
?>
<form action="index.php?mod=news&act=xl_edit" method="POST">
...
$id_group = $rows['id'];
$str3 = "SELECT * FROM tbl_group_news WHERE level=$id_group AND id_lang=$id_lang";
