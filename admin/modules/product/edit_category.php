...
<?php
$id = $_GET['id'];
$str2 = "SELECT * FROM tbl_group_product WHERE id = $id AND id_lang = $id_lang";
$result2 = mysql_query($str2);
$rows2 = mysql_fetch_array($result2);


$str = "SELECT * FROM tbl_group_product WHERE id != $id AND level = 0 AND id_lang = $id_lang";
$result = mysql_query($str);
?>
<form action="index.php?mod=product&act=xl_edit_category" method="POST">
